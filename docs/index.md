...
<div class="hero-banner">
  <div class="hero-inner">
    <div class="hero-kicker">BitFi Docs</div>
    <div class="hero-title">Unlock Native Yield Through CeDeFi</div>
    <p class="hero-subtitle">
      Explore the BitFi CeDeFi stack, product guides, and developer references in one streamlined handbook.
    </p>
  </div>
</div>
